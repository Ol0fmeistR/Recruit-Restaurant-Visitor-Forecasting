...
model1 = ensemble.GradientBoostingRegressor(learning_rate=0.3, random_state=3, n_estimators=200, subsample=0.8, 
                      max_depth =10)
model2 = ensemble.RandomForestRegressor(n_estimators=120, criterion="mse")
model3 = XGBRegressor(learning_rate=0.3, random_state=3, n_estimators=200, subsample=0.8, 
...
test['visitors'] = 0.15*preds1+0.15*preds2+0.40*preds3+0.30*preds4
